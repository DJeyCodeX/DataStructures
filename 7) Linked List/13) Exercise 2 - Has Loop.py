...
class LinkedList:
    ...
    def has_loop(self):
        ...
        while fast and fast.next:
            slow = slow.next
            fast = fast.next.next
            if slow == fast: #Check if the slow pointer meets the fast pointer:
                return True
        return False # #  If we've gone through the entire list and the pointers never met, 
        # then the list doesn't have a loop.
